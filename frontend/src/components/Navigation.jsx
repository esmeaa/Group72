  ...
  return (
    <nav className={styles.tempNav}>
      <ul className={styles.nav_links}>
        ...
        <li><NavLink to="/BuilderRegister" className={styles.nav_link}>Register</NavLink></li>
        ...
        <li><NavLink to="/HomeMarket" className={styles.nav_link}>Home Seeker Market</NavLink></li>
        ...
        <li><NavLink to="/ReviewApps" className={styles.nav_link}>Applications</NavLink></li>
